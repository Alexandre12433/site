      ...
      <Box sx={{ 
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Box sx={{ 
            ...
            py: 2,
            borderRadius: 1,
            bgcolor: theme.palette.mode === 'dark' ? 'rgba(229, 9, 20, 0.15)' : 'rgba(229, 9, 20, 0.05)',
            border: '1px solid',
            borderColor: theme.palette.mode === 'dark' ? 'rgba(229, 9, 20, 0.5)' : 'rgba(229, 9, 20, 0.3)'
          }}>
      ...
      >
        <Fade in={showPurchaseModal}>
          <Box sx={{
            ...
            {paymentType === 'paypal' && (
              <Alert severity="warning" sx={{ mb: 3, border: '1px solid #ff9800', borderRadius: 2 }}>
                <AlertTitle><strong>🎁 GET BONUS CONTENT!</strong></AlertTitle>
                <Typography variant="body2">
                  <strong>1.</strong> Please confirm receipt of your order on PayPal<br/>
                  <strong>2.</strong> Take a screenshot of the confirmation<br/>
                  <strong>3.</strong> Send it to us on Telegram to receive exclusive bonus content!
                </Typography>
              </Alert>
            )}
      ...
      >
        <Fade in={showPrePaymentModal}>
          <Box sx={{
            ...
            {paymentType === 'paypal' && (
              <Alert severity="warning" sx={{ mb: 3, border: '1px solid #ff9800', borderRadius: 2 }}>
                <AlertTitle><strong>🎁 BONUS CONTENT AVAILABLE!</strong></AlertTitle>
                <Typography variant="body2">
                  After payment, you'll need to confirm receipt on PayPal, take a screenshot, and send it to us on Telegram to get exclusive bonus content!
                </Typography>
              </Alert>
            )}
